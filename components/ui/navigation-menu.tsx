...
const NavigationMenu = React.forwardRef<
    ...
    React.ComponentPropsWithoutRef<typeof NavigationMenuPrimitive.Root> & { renderViewport: boolean }
...
const NavigationMenuViewport = React.forwardRef<
    ...
    React.ComponentPropsWithoutRef<typeof NavigationMenuPrimitive.Viewport> & { customStyle?: React.CSSProperties }
>(({ className, customStyle, ...props }, ref) => (
    <div className={cn(`absolute left-0 top-full flex justify-center`)} style={customStyle}>
